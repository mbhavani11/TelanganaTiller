...
from Tillu_bot import get_crop_advice
...
st.markdown("---")
st.subheader("🤖 Tillu Chatbot – Ask Me About Crops!")
# Initialize session state for chat history
if "chat_history" not in st.session_state:
    st.session_state.chat_history = []

user_question = st.text_input("Ask a farming question", key="user_input")

if user_question:
    answer = get_crop_advice(user_question)
    st.session_state.chat_history.append(("You", user_question))
    st.session_state.chat_history.append(("Tillu", answer))
